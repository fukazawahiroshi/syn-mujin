...
var config = {
	...
	columns:[{header:'email',width:120,name:'email',order:false},
	         {header:'姓',width:120,name:'sname',order:false},
		...
		{header:'拠点',width:50,name:'location',align:'center',order:false},
		...
		{header:'表示',width:50,align:'center',
			data:function(obj,id,tr){
				...
				.html('Edit')
				.click(function(){
					setNeedToShowId(this.checked, obj.email);
				});
				return b;
			}
		}],
